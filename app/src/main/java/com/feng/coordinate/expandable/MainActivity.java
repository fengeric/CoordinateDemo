package com.feng.coordinate.expandable;
...
import com.feng.coordinate.CoordinateActivity;
import com.feng.coordinate.R;
import com.feng.coordinate.expandable.ui.PinnedHeaderExpandableListView;
import com.feng.coordinate.expandable.ui.StickyLayout;
...
public class MainActivity extends Activity implements
            ...
            if (convertView == null) {
                ...
                button.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(MainActivity.this, "clicked pos=",
    ...
    public boolean giveUpTouchEvent(MotionEvent event) {
        // 当布局内控件A和StickyLayout滑动冲突时，判断控件A是否滑到顶部，若滑到顶部，return true即可
